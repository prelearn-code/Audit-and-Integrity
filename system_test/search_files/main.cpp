 ...
 * main.cpp - 搜索性能测试主程序
 *
 * 使用 SearchPerformanceTest 类进行完整的搜索性能测试
 *
 * 编译:
 *   make
 *
 * 运行:
 *   ./search_perf_test [配置文件路径]
 *   默认配置: system_test/search_files/config/search_test_config.json
 */
...
namespace {
const char* kDefaultConfigPath = "system_test/search_files/config/search_test_config.json";
}

void printUsage(const char* program_name) {
    std::cout << "\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━" << std::endl;
    std::cout << "🔍 搜索性能测试工具" << std::endl;
    std::cout << "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n" << std::endl;
...
int main(int argc, char* argv[]) {
    ...
    // 打印欢迎信息
    std::cout << "\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━" << std::endl;
    std::cout << "🔍 VDS 搜索性能测试工具 v1.0" << std::endl;
    std::cout << "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n" << std::endl;
    ...
    std::string csv_file = "system_test/search_files/results/search_detailed.csv";
    std::string json_file = "system_test/search_files/results/search_summary.json";
